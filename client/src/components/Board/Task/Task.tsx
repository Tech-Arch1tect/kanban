...
export function Task({
  ...
  return (
    <div className="relative">
      {hovered && hoveredMoveAfter === false && (
        <div className="absolute top-0 left-0 w-full border-t-2 border-blue-500 pointer-events-none" />
      )}
      {hovered && hoveredMoveAfter && (
        <div className="absolute bottom-0 left-0 w-full border-t-2 border-blue-500 pointer-events-none" />
      )}
